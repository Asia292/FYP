...
*/
class PlatTemp : public sf::RectangleShape
{
private:
...
public:
	PlatTemp() {};		//!< Default constructor
	PlatTemp(b2World * world, const sf::Vector2f& position, const sf::Vector2f &size, const float orientation);		//!< Full constructor
