...
public:
	...
	void setFlip(bool Flip);	//!< Specifies the flip bool
	...
	int getFrame() { return currFrame; }		//!< Returns the current animation frame
	bool getFlip() { return flip; }			//!< Returns the flip bool
};
